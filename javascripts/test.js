;(function ($, window, undefined) {
    ...
    $.ajax({ 
      ...
      success: function(data) {
        ...
        $.each(data.photosets.photoset, function(i,photoset){ 
          ...
          var colCover = getCover(API_KEY,photoset.id, photoset);
  ...
  function getCover(API_KEY,PS_ID, photoset) {
    var cover_img;
    ...
    $.ajax({ 
      ...
      success: function(data) {
        ...
        var photo = data.photoset;



        cover_img ='<img src="http://farm5.static.flickr.com/'+photo.photo[0].server+'/'+photo.photo[0].id+'_'+photo.photo[0].secret+'_b.jpg" rel="'+photo.photo[0].title+'"/>';
        console.log(cover_img);
        var gallery ='<li> <div class="gallery"><h1>'+photoset.title._content+'</h1>'+cover_img+'</div></li>';
        console.log(gallery);
